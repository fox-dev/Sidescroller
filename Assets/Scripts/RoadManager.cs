...
public class RoadManager : MonoBehaviour {
    ...
    public void AppendRoad()
    {
        ...
        {
            nextRoadSet.transform.position = new Vector3(currentRoadSet.transform.FindChild("FrontEnd").transform.position.x - 1f, currentRoadSet.transform.FindChild("FrontEnd").transform.position.y, currentRoadSet.transform.position.z);
